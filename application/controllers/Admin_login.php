...
class Admin_login extends CI_Controller {
    ...
    function login_action()
	{
        ...
        $id_hak_akses     = '1'; //Ini Hak Akses Admin
        /** Ambil seluruh data dari hasil input form, dimasukkan ke variabel berakhir */
        
        //Periksa ketersediaan hak akses sebagai admin
		$cek_avaibility   = $this->Grup_user_model->cek_avaibility($ktp, md5($password), $id_hak_akses);
        
        if($cek_avaibility == 'TRUE') //Jika ketersediaan hak akses sebagai admin = TRUE
        {            
            //Set Session No. KTP, dan status Login
            $arraysesi    = array('ktp' => $ktp, 'login_admin' => 'TRUE'); //Tampung Data Login di Array
        ...
        else if($cek_avaibility =='FALSE') //Jika ketersediaan hak akses sebagai admin == FALSE, maka kembali ke Halaman Login
        {
