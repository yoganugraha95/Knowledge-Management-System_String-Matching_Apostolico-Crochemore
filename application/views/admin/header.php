...
<html lang="id">
  ...
  <head>
    ...
    <title>Administrator KMS PT Titis Sampurna</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() ?>divisi">Divisi</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>admin_login/logout_action">Log Out</a>
            </li>
          </ul>
        </div>
      </div>
