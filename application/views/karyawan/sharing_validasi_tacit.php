        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    <?php
                        ...
                        {
                    ?>
                    <a href="<?php echo base_url() ?>sharing/validasi_tacit_knowledge" class="list-group-item active">Validasi Tacit Knowledge</a>
            ...
            <div class="col-lg-9">
                ...
                <div class="card card-outline-secondary my-4">
                    ...
                    <div class="card-body">
                    <?php
                        if($list_all_tacit_knowledge->num_rows() == 0)
                        {
                    ?>
                    ...
                    <?php
                            $no = 1;
                            foreach($list_all_tacit_knowledge->result() as $row)
                            {
                    ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><a href="<?php echo base_url(); ?>capture/profil/<?php echo $row->id_tacit_knowledge; ?>"><?php echo $row->judul; ?></a></td>
