                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                <form method="post" action="<?php echo base_url(); ?>report/presentase_search">
                                    <div class="form-row">
                                        <div class="col">
                                            <input type="text" class="form-control datepicker" name="tanggal_presentase_mulai" placeholder="Tanggal Mulai" required="" />
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control datepicker" name="tanggal_presentase_berakhir" placeholder="Tanggal Berakhir" required=""/>
                                        </div>
                                        <div class="col">
