        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    <a href="<?php echo base_url() ?>superintendent/profil" class="list-group-item active">Profil</a>
                    <a href="<?php echo base_url() ?>superintendent/ubah_profil" class="list-group-item">Ubah Profil</a>
                    <a href="<?php echo base_url() ?>superintendent/ubah_password" class="list-group-item">Ubah Password</a>
                </div>
            </div>
            <!-- /.col-lg-3 -->
                            ...
                            <div class="col-lg-8">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><a href="<?php echo base_url();?>superintendent/karyawan/<?php echo $row->user_dibuat_oleh; ?>"><?php echo $row->user_dibuat_oleh; ?></a></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <a href="<?php echo base_url();?>superintendent/karyawan/<?php echo $row->user_diperbarui_oleh; ?>"><?php echo $row->user_diperbarui_oleh; ?></a>
                                        </td>
                                    </tr>
                                    <tr>
