        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    <a href="<?php echo base_url() ?>superintendent/profil" class="list-group-item">Profil</a>
                    <a href="<?php echo base_url() ?>superintendent/ubah_profil" class="list-group-item active">Ubah Profil</a>
                ...
                <div class="card card-outline-secondary my-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            ?>
                                <br />
                                <form method="post" action="<?php echo base_url(); ?>superintendent/perbarui_foto_profil" enctype="multipart/form-data" />
                            ...
                            <div class="col-lg-8">
                                <form action="<?php echo base_url();?>superintendent/perbarui_profil" method="post" id="form-regis">
                                    <?php
